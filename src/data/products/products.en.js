...
const PRODUCT_TYPE_COAT = "coats"
const PRODUCT_TYPE_BLAZER = "blazers"
const PRODUCT_TYPE_SUIT = "suits"
const PRODUCT_TYPE_SHIRT = "shirts"
const PRODUCT_TYPE_PANTS = "pants"
...
module.exports = [
  ...
  {
    type: PRODUCT_TYPE_DRESS,
    displayName: "Orange is the new black",
    description: [
  ...
  {
    type: PRODUCT_TYPE_DRESS,
    displayName: "The woman in the red dress",
    description: [
  ...
  {
    type: PRODUCT_TYPE_SHORTS,
    displayName: "White frayed denim",
    description: [
  ...
  {
    type: PRODUCT_TYPE_SHORTS,
    displayName: "Denim shorts with tear",
    description: [
  ...
  {
    type: PRODUCT_TYPE_PANTS,
    displayName: "Red hipster tights",
    description: [
  ...
  {
    type: PRODUCT_TYPE_PANTS,
    displayName: "Off-white pants for the grown-up woman",
    description: [
  ...
  {
    type: PRODUCT_TYPE_PANTS,
    displayName: "Dark gray hipster pants",
    description: [
  ...
  {
    type: PRODUCT_TYPE_PANTS,
    displayName: "Light-blue normal-fit denim",
    description: [
  ...
  {
    type: PRODUCT_TYPE_PANTS,
    displayName: "Black pants with white stripes",
    description: [
  ...
  {
    type: PRODUCT_TYPE_PANTS,
    displayName: "Off-white slim-fit pants",
    description: [
  ...
  {
    type: PRODUCT_TYPE_PANTS,
    displayName: "Off-white pants for leisure",
    description: [
  ...
  {
    type: PRODUCT_TYPE_PANTS,
    displayName: "Classy trousers for the classy gentleman",
    description: [
  ...
  {
    type: PRODUCT_TYPE_PANTS,
    displayName: "Green modern pants",
    description: [
  ...
  },
  {
    ...
    displayName: "Blue dark leisure suit",
    description: [
  ...
  },
  {
    ...
    displayName: "Gray leisure blazer in cotton",
    description: [
