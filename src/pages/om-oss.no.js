...
const AboutPage = ({ location }) => (
  <PortalPage pageTitle="Om oss" location={location}>
    <h1>Om oss</h1>
    <section>
      <h2>What is it?</h2>
      <p>
    ...
    <section>
      ...
      <p>
        ...
        see the <Link to={portalURLs.no.howTo}>Howto</Link> for use and
    ...
    <section>
      ...
      <ul>
        ...
        <li>
          ...
          <a
            href={portalURLs.no.norskRegnesentral}
            target="_blank"
            rel="noopener noreferrer"
          >
