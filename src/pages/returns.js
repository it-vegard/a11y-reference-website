...
const ReturnsPage = ({ location }) => (
  <App pageTitle="Exchanges and returns" location={location}>
    ...
    <p>
      ...
      in an Accessible Clothes shop or by returning the goods to us.
    </p>
    <p>
      Please see the list of Accessible Clothes shops on this website. To
      exchange something in a shop, please bring the receipt that has been
      emailed to you.
    </p>
    <section>
      <h2>Exchanging goods</h2>
      <p>
        The easiest way to exchange goods is in an Accessible Clothes shop. If
        you wish to return goods to our online shop, you will get your money
        back and you will have to place a new order if you would like a new
    ...
    <section>
      ...
      <p>
        ...
        and either return it to an Accessible Clothes shop or send it back to
        us.
      </p>
      <p>
        As a consumer, you have the right to cancel a purchase if your order is
        delayed. If Accessible Clothes is aware that goods’ delivery items will
        be delayed, we will inform you of the new delivery date. You can then
    ...
    <section>
      ...
      <p>
        If you wish to return a faulty Accessible Clothes product, the easiest
        way to do this is in an Accessible Clothes shop. Bring the receipt that
